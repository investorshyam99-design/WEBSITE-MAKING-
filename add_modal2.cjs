...
if (!code.includes("Size Guide Modal")) {
    code = code.replace(
    ...
    code = code.replace(
        'https://images.unsplash.com/photo-1620799140188-3b2a02fd9a77?q=80&w=2000&auto=format&fit=crop',
        'https://i.imgur.com/t4wt92I.png'
    );
    fs.writeFileSync('src/pages/ProductPage.tsx', code);
    console.log("Updated Size Guide image");
}
