    ...
    <div className="fixed inset-0 z-[60] bg-white/95 backdrop-blur-md flex flex-col">
      <div className="p-4 md:p-8 flex items-center gap-4 max-w-7xl mx-auto w-full border-b border-[#EDE3D8]">
        ...
        <input
          ...
          className="flex-1 bg-transparent border-none text-xl md:text-3xl font-black uppercase tracking-tight text-[#1B1B1B] placeholder:text-gray-300 focus:outline-none focus:ring-0"
        />
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-8 max-w-7xl mx-auto w-full">
        {query && results.length === 0 ? (
          <p className="text-[#F5EFE6]0 text-center mt-12 font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4 md:gap-6">
            {results.map((product) => (
              ...
              >
                <div className="aspect-[3/4] bg-[#F5EFE6] overflow-hidden border border-[#EDE3D8]">
                  <img
